		...
		<form id="submitForm">
			<table>
				...
				<tr>
					...
					<td><input type="text" name="mf11_compCodeHRIS"
						id="mf11_compCodeHRIS"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="mf11_compAbbrName"
						id="mf11_compAbbrName"></td>
				</tr>

				<tr>
					<th>Company Registration Number</th>
					<td><input type="text" name="mf11_compRegNo"
						id="mf11_compRegNo"></td>
				</tr>
				...
				<tr>
					<th>Status</th>
					<td>Y<input type="radio" name="mf11_isActive" value="1"
						checked> N<input type="radio" name="mf11_isActive"
						value="0">
					</td>
				</tr>
